...
const data = [
  {
    ...
    image: UpSkillMePic,
    description:
      "The UpSkillMe project was part of Founders and Coders’ Tech for Better scheme, which connects junior developers with small businesses and charities. The prototype is targeted at school-age children and acts a digital record of extra-curricular achievements. The project has since been developed further by the product owners, who have raised seed funding.",
  ...
  },
  {
    ...
    image: FoodMilesPic,
    description:
      "Food Miles is designed to help shoppers discover how locally-sourced their food is by comparing the origins of fresh produce across different supermarket chains. The app was created as a proof-of-concept using mock data retrieved from a PostgreSQL database.",
  ...
  },
  {
    ...
    image: BugBearsPic,
    description:
      "Bugbears is a dynamic web app that lets users log-in and add their grievances to a list of ‘pet peeves’. The project uses a PostgreSQL database that is connected to a Node.js server and was built using HTML, CSS and JavaScript.",
  ...
  },
  {
    ...
    description:
      "Project Fear was built to provide a live countdown to the October 31st Brexit deadline. The site also includes a currency exchange rate converter, with a comparative value marker set to summer 2015,  using a call to the Foreign Exchange Rates API.",
  ...
  },
  {
    ...
    description:
      "This website’s autocomplete functionality lets users easily find and select country names while typing a query into the search box. Pressing the 'Go' button takes you to the corresponding county’s Wikipedia page.",
  ...
  },
  {
    ...
    description:
      "This web app makes three API calls and updates the DOM with the results. The XMLHttpRequest object is used to query the TFL, Picsum and ‘Corporate B.S Generator’ APIs. The results are rendered on a dashboard-style display along with the time and date.",
